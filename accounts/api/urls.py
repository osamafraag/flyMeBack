...
urlpatterns = [
    ...
    path('user/wallet/',userWallet,name='wallets.user'),
    ...
    path('user/transactions',userTransactions,name='user.transactions'),
    ...
    path('user/paymentCards',userPaymentCards,name='user.paymentCards'),
